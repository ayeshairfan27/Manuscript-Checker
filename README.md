...
*(Add at least 3 screenshots here — e.g. the input form, the results/checklist screen, and the optional journal-instructions field expanded. Upload the images to the repo and reference them like this:)*

```
![Input form](screenshots/input-form.png)
![Results checklist](screenshots/results.png)
![Journal instructions field](screenshots/journal-instructions.png)
```
